...
| GREEN — read-only source/folder rename | `2f4e5f6` | same target, then `npm run build`, `npm test`, and `npm audit --audit-level=high` | Focused suite: 13 tests passed; full suite: 31 tests passed; TypeScript passed; 0 vulnerabilities. |
